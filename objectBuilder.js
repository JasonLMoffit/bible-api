...
// const makeObj = (object, book, chapter, verse) => {
//   object = {
//     book,
//     chapter,
//     verse,
...
//   return object;
// };
// const test = baruch.map((chapter) => chapter.forEach((verse) => verse));
// const getIndex = (array) => {
//   let index;
//   array.map((item) => (index = index += 1));
//   return index;
// };

// console.log(getIndex(baruch))

// Get index
for (chapter in baruch) console.log(parseInt(chapter) + 1);
for (chapter in baruch) console.log([...chapter]);
